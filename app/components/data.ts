  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Open the JourneyLite patient education portal.",
      },
      {
...
export const surgicalOptions = [
  {
    ...
    description: "A well-established bariatric procedure that can support significant weight loss and metabolic health goals.",
    bestFor: "May be a fit for patients with higher weight-loss goals, reflux concerns, or certain metabolic needs.",
    points: [
      "Well-established bariatric procedure",
      "Supports significant weight loss",
      "May help with metabolic health goals",
      "Often considered for reflux concerns",
      "Best for patients with higher weight-loss goals",
    ],
    href: "/services/gastric-bypass",
  ...
  },
  {
    id: "sadi-surgery",
    title: "SADI Surgery",
    description: "An advanced bariatric option that may be recommended for eligible patients who need more powerful metabolic support.",
    bestFor: "May be a fit for patients with higher BMI ranges or complex metabolic goals.",
    points: [
      "Advanced bariatric surgery option",
      "Designed for powerful metabolic support",
      "May support significant long-term weight loss",
      "Often considered for higher BMI ranges",
      "Best for patients with complex metabolic goals",
    ],
    href: "/services/sadi-surgery",
  ...
  },
  {
    ...
    description: "An adjustable surgical option that places a band around the upper stomach to support portion control.",
    bestFor: "May be a fit for select patients who want an adjustable surgical tool and ongoing follow-up.",
    points: [
      "Adjustable surgical weight-loss option",
      "Places a band around the upper stomach",
      "Supports portion control",
      "Requires ongoing follow-up and adjustments",
      "Best for select patients wanting an adjustable tool",
    ],
    href: "/services/lap-band-surgery",
  ...
  },
  {
    ...
    description: "Revision care for patients who had a prior lap band and need a new plan for comfort, safety, or weight loss.",
    bestFor: "May be a fit when a prior band is no longer meeting clinical or lifestyle goals.",
    points: [
      "Revision care after prior lap band surgery",
      "Helps address comfort or safety concerns",
      "May support renewed weight-loss progress",
      "Creates a new plan when the band no longer fits goals",
      "Best for patients needing evaluation after band surgery",
    ],
    href: "/services/gastric-band-revision",
  ...
  },
  {
    ...
    description: "Evaluation and planning for patients who previously had gastric sleeve surgery and need renewed support.",
    bestFor: "May be a fit for weight regain, anatomy concerns, or changing medical needs after sleeve surgery.",
    points: [
      "Evaluation after prior gastric sleeve surgery",
      "Helps address weight regain concerns",
      "May be used for anatomy or medical changes",
      "Supports renewed planning and long-term care",
      "Best for patients needing support after sleeve surgery",
    ],
    href: "/services/gastric-sleeve-revision",
  ...
  },
  {
    ...
    description: "Related surgical care delivered by physicians with focused experience in abdominal and bariatric procedures.",
    bestFor: "May be a fit for patients who need coordinated surgical evaluation alongside weight loss care.",
    points: [
      "Related abdominal surgical care",
      "Coordinated with bariatric expertise",
      "Supports patients needing surgical evaluation",
      "May complement weight-loss treatment planning",
      "Best for patients needing broader surgical care",
    ],
    href: "/services/general-surgery",
...
export const oralMedicationOptions = [
  {
    ...
    bestFor: "Not appropriate for everyone, especially certain blood pressure, heart, anxiety, or insomnia concerns.",
    points: [
      "Oral appetite suppressant",
      "May help jump-start early progress",
      "Requires provider screening before starting",
      "Not right for every medical history",
      "Best for appropriate patients needing short-term appetite support",
    ],
    href: "/services/phentermine-adipex",
    cta: "Learn About Phentermine",
  },
  {
    id: "qsymia",
    title: "Qsymia",
    description: "An oral prescription medication option that may help eligible patients manage appetite and weight-loss progress.",
    bestFor: "May be considered when provider screening supports oral medication therapy and monitoring.",
    points: [
      "Combination oral prescription medication",
      "May help manage appetite and progress",
      "Considered when oral therapy is appropriate",
      "Requires ongoing treatment monitoring",
      "Best for patients who qualify for a structured oral option",
    ],
  ...
  },
  {
    id: "contrave",
    title: "Contrave",
    description: "An oral medication option that may support craving and appetite management for eligible patients.",
    bestFor: "May fit patients whose medical history and current medications allow this treatment path.",
    points: [
      "Oral medication for cravings and appetite",
      "May support behavioral eating patterns",
      "Reviewed alongside current medications",
      "Requires provider screening before prescribing",
      "Best for eligible patients needing craving-focused support",
    ],
...
export const injectableMedicationOptions = [
  {
    ...
    description: "A weekly GLP-1 medication that may support appetite control, metabolic health, and steady weight-loss progress for eligible patients.",
    bestFor: "Requires medical screening, dose titration, and follow-up.",
    points: [
      "Weekly GLP-1 injectable medication",
      "May support appetite control",
      "Can help with steady weight-loss progress",
      "Requires screening, dose titration, and follow-up",
      "Best for eligible patients wanting injectable medical support",
    ],
    href: "/services/wegovy-semaglutide",
    cta: "Learn About Wegovy",
  },
  {
    id: "zepbound-tirzepatide",
    title: "Zepbound / Tirzepatide",
    description: "A weekly GIP/GLP-1 medication option that may support appetite regulation and metabolic weight-loss goals for eligible patients.",
    bestFor: "Coverage, cost, side effects, and eligibility vary.",
    points: [
      "Weekly GIP/GLP-1 injectable medication",
      "May support appetite and metabolic goals",
      "One of the newer injectable options",
      "Eligibility, side effects, coverage, and cost vary",
      "Best for patients exploring advanced injectable therapy",
    ],
