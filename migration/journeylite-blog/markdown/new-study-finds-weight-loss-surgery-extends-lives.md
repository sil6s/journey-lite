...
## Source URL
https://journeylite.com/new-study-finds-weight-loss-surgery-extends-lives/
...
## Meta Description
<figure class="wpbwrapper vcfigure"><a href="https://journeylite.com/surgical-weight-loss/" target="blank" class="vcsingleimage-wrapper vcboxshadow3d  vcboxbordergrey"><img loading="lazy" decoding="async" width="1024" he

## Excerpt
<figure class="wpbwrapper vcfigure"><a href="https://journeylite.com/surgical-weight-loss/" target="blank" class="vcsingleimage-wrapper vcboxshadow3d  vcboxbordergrey"><img loading="lazy" decoding="async" width="1024" he

## Featured Image
/legacy-blog/new-study-finds-weight-loss-surgery-extends-lives__Vertical-Gastric-Sleeve-Anatomy.jpg

## Featured Image Alt Text
New Study Finds Weight Loss Surgery Extends Lives — JourneyLite
...
## External Sources
- [tracheostomy](https://www.mayoclinic.org/tests-procedures/tracheostomy/about/pac-20384673)
...
There have been other large studies that support the data seen here, so I feel like it’s about time to **shout it from the rooftops!**  In the U.S., it’s estimated that only 2% of patients who _qualify_ actually end up _having_ weight loss surgery.  Some of this is related to lack of insurance coverage, and some to patients’ reluctance to seek out weight loss surgery.  Many patients are not even aware that, when they choose an insurance plan, it may exclude access to a surgical weight loss procedure which they qualify for medically.  Not because they don’t need it, but because language is written into their policy that says it’s not going to be covered, no matter how badly they need it.
