...
## Source URL
https://journeylite.com/weight-loss-surgery-requirements-explained/

## Canonical URL
https://journeylite.com/weight-loss-surgery-requirements-explained/

## Original Slug
weight-loss-surgery-requirements-explained

## Title
Bariatric Surgery Requirements Explained by a Weight Loss Surgeon
...
## Published At
2023-09-27T14:33:18+00:00

## Original Published At
2023-09-27T14:33:18+00:00

## Updated At
2025-08-20T16:06:16+00:00
...
## Meta Description
Explore the bariatric surgery requirements from an experienced surgeon to see if you qualify for weight loss surgery and regain your health.

## Excerpt
Explore the bariatric surgery requirements from an experienced surgeon to see if you qualify for weight loss surgery and regain your health.

## Featured Image
/legacy-blog/weight-loss-surgery-requirements-explained__bariatric-surgery-requirements-1-scaled.jpg.webp

## Featured Image Alt Text
Bariatric Surgery Requirements Explained by a Weight Loss Surgeon — JourneyLite

## Internal Links
- [Check your BMI here!](https://journeylite.com/bmi-calculator/)
- [invasive weight loss surgery](https://journeylite.com/non-surgical-weight-loss/)
...
- [Duodenal switch (or a modification know as SIPS or SADI)](https://journeylite.com/sadi-surgery/)
- [For a comprehensive list, check here](https://journeylite.com/journeylite-accepts-most-insurance-plans-for-weight-loss-surgery/)
- [Find out if you have coverage for weight loss surgery!](https://journeylite.com/do-i-have-coverage-for-weight-loss-surgery/)
- [For more information on self pay options, click here](https://journeylite.com/pricing-financing/)
- [Click here to calculate your BMI](https://journeylite.com/bmi-calculator/)
...
Let’s get the easy part out of the way first.  Here are the bariatric surgery requirements published by the (https://asmbs.org/patients/who-is-a-candidate-for-bariatric-surgery):
...
These guidelines were just released in 2022. They replaced the antiquated 1991 NIH guidelines for weight loss surgery, which were used for decades. The NIH bariatric surgery qualifications were not useful because they were written before the era of minimally (https://journeylite.com/non-surgical-weight-loss/). So they were written during a time when all operations were done with a large, old-fashioned incision.

Notice that the language in the new guidelines is strong because the data is strong to support weight loss surgery.  It doesn’t say that surgery could be _considered_, or that a patient might _opt_ to have surgery, it says that **surgery is recommended.**
...
-   (https://journeylite.com/surgical-weight-loss/lap-band/)
-   (https://journeylite.com/surgical-weight-loss/gastric-sleeve-vsg/)
-   (https://journeylite.com/surgical-weight-loss/gastric-bypass-surgery/)
-   (https://journeylite.com/sadi-surgery/)
...
- JourneyLite is in network with almost all carriers. (https://journeylite.com/journeylite-accepts-most-insurance-plans-for-weight-loss-surgery/).
-   **How do I know if my insurance covers weight loss surgery?**
- Coverage for weight loss surgery for private carriers (Anthem, Humana, etc) is usually determined by the employer providing the insurance. JourneyLite can assist you in the process of determining coverage, (https://journeylite.com/do-i-have-coverage-for-weight-loss-surgery/).
...
- JourneyLite specializes in providing affordable self-pay options for patients who need weight loss surgery but don’t have coverage. (https://journeylite.com/pricing-financing/).
...
- At a minimum, a patient must have a BMI of 30. (https://journeylite.com/bmi-calculator/).
